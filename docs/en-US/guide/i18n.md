...
Element Plus Mobile components use English **by default**. If you want to use other
languages, read on to find out how.

## Global configuration

Element Plus Mobile provides global configuration options.
...
Element Plus Mobile also provides a Vue component [ConfigProvider](../component/config-provider.md)
...
If you are using Element Plus Mobile via CDN, you need to do the following. Let's take
unpkg as an example:
